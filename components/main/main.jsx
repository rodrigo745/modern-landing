    ...
    return(
        <div className="mt-20 w-full px-4 z-50">
            <div className="bg-slate-800 p-8 py-14 lg:p-12 lg:py-24 w-full shadow-sm shadow-blue-900">
                ...
                <div className="mt-10 md:mt-28 flex flex-col lg:flex lg:flex-row lg:justify-between z-50">
                ...
                <div className="mt-10 md:mt-28 flex flex-col lg:flex lg:flex-row z-50 lg:justify-between space-y-10 lg:space-y-0 lg:space-x-10">
                    <div>
                        <div className="w-[100%]">
                            <p className="border-t-4 w-14 lg:w-16 border-orange-500"></p>
